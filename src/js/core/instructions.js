...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind1 */ `<p>In this experiment, you will see an image of a person briefly flash in a random location on the screen.</p><p>Each image will flash on screen for only a short amount of time, so pay close attention!</p><p>Your task is straightforward: After the person disappears, you will be asked to recreate the exact size of the person you saw. There will be a slider at the bottom of your screen, which you can drag to adjust the size your recreation. Do your best to match the size of the person you saw as accurately as possible.</p>`,
