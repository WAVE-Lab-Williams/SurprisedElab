...
function loadInstrContent() {
    ...
    // var instrContent = [
    //     /* ind0 */ '<p>Hello! Thank you for participating in our study. Please take a moment to adjust your seating so that you can comfortably watch the monitor and use the keyboard. Feel free to dim the lights as well.</p><p>Close the door or do whatever is necessary to <b>minimize disturbance during the experiment</b>. Please also take a moment to silence your phone so that you are not interrupted by any messages mid-experiment. Do <i>not</i> switch to any other tabs or windows until you are complete.</p>',
    //     /* ind1 */ `<p>A cross will briefly appear in the center of the screen. Then, right after, an image will appear somewhere on the screen for a short time.</p><p>Your job is simple: after the image disappears, you will be asked to <b>recreate the size of the image that was on screen</b>. <p>On the next page, we will show you an example.</p>`,
    //     /* ind2 */ `<p>As you just experienced, the image flashes quickly, and its hard to get the size exactly right. The images will change throughout the experiment, but your job stays the same.</p><p>Each time an image disappears, <b>use the slider to recreate the size that image was on screen.</b></p>`,
    //     /* ind3 */ `<p>Sometimes, you may be unsure of your answer. This is okay, since the task is designed to be difficult, as images flash quickly, and it is hard to nail exact sizing!  In times like this, just give it your <b>best guess, trying to be as precise as possible</b>, as we are interested in your <i>gut intuition</i>.</p><p>Please do your very best to remain as focused and attentive as possible, even at the end of the experiment. I know it is very difficult to stay focused for so long, especially when you are doing the same thing over and over. But remember, the experiment will be all over in less than ${String(estTotalRunTime)} minutes. Press the button below to begin.`,  
    // ];

    // multiple trial version for two object spacing instructions
    var instrContent = [
        /* ind0 */ '<p>Hello! Thank you for participating in our study. Please take a moment to adjust your seating so that you can comfortably watch the monitor and use the keyboard. Feel free to dim the lights as well.</p><p>Close the door or do whatever is necessary to <b>minimize disturbance during the experiment</b>. Please also take a moment to silence your phone so that you are not interrupted by any messages mid-experiment. Do <i>not</i> switch to any other tabs or windows until you are complete.</p>',
        /* ind1 */ `<p>A cross will briefly appear in the center of the screen. Then, right after, two images will appear somewhere on the screen for a short time (one will appear shortly before the other).</p><p>Your job is simple: after the two images disappear, you will be asked to <b>recreate the how far the images were from each other</b>. <p>On the next page, we will show you an example.</p>`,
        /* ind2 */ `<p>As you just experienced, the images flash quickly, and its hard to get the distance between the images exactly right. The images will change throughout the experiment, but your job stays the same.</p><p>Each time the images disappear, <b>use the slider to recreate the distance that was between them</b>.</p>`,
        /* ind3 */ `<p>Randomly, every few rounds, you'll also be asked an additional question. Specifically, you'll be asked about the <b>hairstyle</b> of the person you saw. (You will be given options to choose from.)</p><p>So don't forget to pay attention to the hairstyle, while <b>still doing your best to recreate the distance between the two images</b>.</p>`,
        /* ind4 */ `<p>Sometimes, you may be unsure of your answer. This is okay, since the task is designed to be difficult, as images flash quickly, and it is hard to nail exact spacing!  In times like this, just give it your <b>best guess, trying to be as precise as possible</b>, as we are interested in your <i>gut intuition</i>.</p><p>Please do your very best to remain as focused and attentive as possible, even at the end of the experiment. I know it is very difficult to stay focused for so long, especially when you are doing the same thing over and over. But remember, the experiment will be all over in less than ${String(estTotalRunTime)} minutes. Press the button below to begin.`,  
    ];
