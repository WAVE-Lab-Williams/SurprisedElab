...
function loadInstrContent() {
    ...
    var instrContent = [
        ...
        /* ind2 */ `<p>As you just experienced, the images flash quickly, and its hard to get the distance between the images exactly right. The images will change throughout the experiment, but your job stays the same.</p><p>Each time an image disappears, <b>use the slider to recreate the size that image was on screen.</b></p>`,
        /* ind3 */ `<p>Sometimes, you may be unsure of your answer. This is okay, since the task is designed to be difficult, as images flash quickly, and it is hard to nail exact sizing!  In times like this, just give it your <b>best guess, trying to be as precise as possible</b>, as we are interested in your <i>gut intuition</i>.</p><p>Please do your very best to remain as focused and attentive as possible, even at the end of the experiment. I know it is very difficult to stay focused for so long, especially when you are doing the same thing over and over. But remember, the experiment will be all over in less than ${String(estTotalRunTime)} minutes. Press the button below to begin.`,  
    ];
