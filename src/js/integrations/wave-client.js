...
function processTrialData(data) {
    ...
    if (data.trial_category && data.trial_category.includes('expt')) {
        ...
        const waveData = {
            ...
            choice_array_order: JSON.stringify(data.choice_array_order),
            correct_gender: data.correct_gender,
            thisAcc: data.thisAcc,
            response_time: data.rt,
            slider_start: data.slider_start,
            min: data.min,
            max: data.max,
            ...
            anchor_x_position: data.anchor_x_position,
            anchor_y_position: data.anchor_y_position,
            secondary_x_position: data.secondary_x_position,
